...
def main(**deps):
    ...
    # 创建VAE模型配置
    vae_model_path = f"./trained_models/vae/{Config.task}_frac{Config.frac}_sigma{Config.sigma}/vae_latent32.pt"
